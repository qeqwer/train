...
const handleQuery = (param) => {
  ...
  axios.get('/business/admin/daily-train-carriage/query-list', {
    ...
    let data = res.data;
    if (data.success) {
      dailyTrainCarriagelist.value = data.content.list;
      // 设置分页控件的值
...
const onDelete = (record) => {
  axios.delete('/business/admin/daily-train-carriage/delete/' + record.id).then(res => {
    let data = res.data;
    if(data.success){
...
const handleOk = () => {
  axios.post('/business/admin/daily-train-carriage/save', dailyTrainCarriage.value).then(res => {
    let data = res.data;
    if (data.success) {
...
<template>
  ...
  <a-table :dataSource="dailyTrainCarriagelist"
           :columns="columns"

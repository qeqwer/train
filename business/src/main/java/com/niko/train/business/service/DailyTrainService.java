...
import com.niko.train.business.domain.DailyTrain;
import com.niko.train.business.domain.DailyTrainExample;
import com.niko.train.business.domain.Train;
import com.niko.train.business.mapper.DailyTrainMapper;
...
public class DailyTrainService {
    ...
    public void genDailyTrain(Date date, Train train) {
        ...
        // 生成该车次的座位余票数据
        dailyrainTicketService.genDaily(dailyTrain, date, train.getCode());

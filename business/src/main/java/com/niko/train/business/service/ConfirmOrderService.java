...
//        }
        ...
        try {
            ...
            /**
             * waitTime：等待获取锁时间(最大尝试获得锁的时间)，超时返回fasle
             * leaseTime：锁自动释放时间，单位：秒，锁自动释放时间，必须大于0，如果为0，则表示不会自动解锁，需要手动解锁
             * timeUnit：等待获取锁时间单位，默认是秒
             */
            //boolean tryLock = lock.tryLock(5, 3, TimeUnit.SECONDS); // 尝试加锁，最多等待5秒，上锁以后3秒自动解锁（无看门狗）
    ...
    public void doConfirmBlock(ConfirmOrderDoReq req, BlockException e) {
        ...
        throw new BusinessException(BussinessExceptionEnum.CONFIRM_ORDER_FLOW_EXCEPTION);
    }
